  ...
  const experiences = [
    {
      ...
      description:
        "Responsable de la conception et de la mise en œuvre de pipelines CI/CD, de l'automatisation de l'infrastructure et de l'optimisation des performances des applications cloud.",
    },
    {
      id: 2,
      date: "2019 - 2021",
      ...
      description:
        "Migration des infrastructures sur site vers le cloud, mise en place de conteneurs et d'orchestrateurs, et automatisation des déploiements.",
    },
    {
      id: 3,
      date: "2017 - 2019",
      ...
      description:
        "Développement d'applications web et participation à la mise en place des premières pratiques DevOps dans l'entreprise.",
    },
    {
      id: 4,
      date: "2015 - 2017",
      ...
      description:
        "Participation au développement d'applications et apprentissage des bonnes pratiques de développement et de déploiement.",
    },
  ];
    ...
    <div className={styles.about}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          >
            Développeur DevOps passionné avec plus de 5 ans d'expérience dans la
            conception et la mise en œuvre d'infrastructures cloud évolutives et
            sécurisées.
          </motion.p>
        </div>
      </section>
      ...
      <section className={styles.aboutSection} ref={aboutRef}>
        ...
        <div className={styles.aboutContent}>
          ...
          >
            <p>
              Passionné par les technologies cloud et l'automatisation, je me
              suis spécialisé dans le DevOps pour aider les entreprises à
              délivrer des logiciels plus rapidement et de manière plus fiable.
            </p>
            <p>
              Avec une solide expérience en développement et en administration
              système, je mets à profit mes compétences pour concevoir et mettre
              en œuvre des solutions d'infrastructure modernes, évolutives et
              sécurisées.
            </p>
            <p>
              Mon approche se concentre sur l'automatisation, la qualité du code
              et l'amélioration continue pour optimiser les processus de
          ...
          >
            ...
            <ul className={styles.skillsList}>
              <li>
                Expérience éprouvée avec les principales plateformes cloud (AWS,
                Azure, GCP)
              </li>
              <li>
                Expertise en conteneurisation et orchestration (Docker,
                Kubernetes)
              </li>
              <li>
                Maîtrise des outils d'infrastructure as code (Terraform,
                CloudFormation)
              </li>
          ...
          {skills.map((category, index) => (
            ...
            >
              <h3 className={styles.skillTitle}>
                <span className={styles.iconWrapper}>{category.icon}</span>
                {category.category}
              </h3>
