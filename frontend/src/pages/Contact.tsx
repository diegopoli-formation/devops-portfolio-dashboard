  ...
  return (
    <section className={styles.contact} id="contact">
      ...
      <div className={styles.header} ref={ref}>
        ...
        >
          Vous avez une question ou souhaitez discuter d'un projet ? N'hésitez
      ...
      >
        ...
        <motion.div className={styles.contactInfo} variants={itemVariants}>
          ...
          <p className={styles.contactInfoText}>
            Je suis disponible pour discuter de nouveaux projets, opportunités
            de collaboration ou simplement échanger sur des sujets liés au
            développement et aux opérations DevOps.
          </p>
